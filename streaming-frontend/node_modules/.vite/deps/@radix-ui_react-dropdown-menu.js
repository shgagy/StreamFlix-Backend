...
import {
  ...
  useId,
  useLayoutEffect2
} from "./chunk-UIF7P4XF.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-QTVEGEFO.js";
import {
  require_react_dom
...
var Menu = (props) => {
  ...
  const isUsingKeyboardRef = React19.useRef(false);
  ...
  return (0, import_jsx_runtime6.jsx)(Root22, { ...popperScope, children: (0, import_jsx_runtime6.jsx)(
    MenuProvider,
    {
      ...
      children: (0, import_jsx_runtime6.jsx)(
        ...
        {
          scope: __scopeMenu,
          onClose: React19.useCallback(() => handleOpenChange(false), [handleOpenChange]),
          isUsingKeyboardRef,
          dir: direction,
          modal,
          children
...
var MenuAnchor = React19.forwardRef(
  (props, forwardedRef) => {
...
var MenuContent = React19.forwardRef(
  (props, forwardedRef) => {
...
var MenuRootContentModal = React19.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
...
var MenuRootContentNonModal = React19.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
  return (0, import_jsx_runtime6.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React19.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenu,
      loop = false,
    ...
    const [currentItemId, setCurrentItemId] = React19.useState(null);
    const contentRef = React19.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef, context.onContentChange);
    const timerRef = React19.useRef(0);
    const searchRef = React19.useRef("");
    const pointerGraceTimerRef = React19.useRef(0);
    const pointerGraceIntentRef = React19.useRef(null);
    const pointerDirRef = React19.useRef("right");
    const lastPointerXRef = React19.useRef(0);
    const ScrollLockWrapper = disableOutsideScroll ? Combination_default : React19.Fragment;
    ...
    useFocusGuards();
    const isPointerMovingToSubmenu = React19.useCallback((event) => {
      var _a, _b;
    ...
    return (0, import_jsx_runtime6.jsx)(
      MenuContentProvider,
      {
        scope: __scopeMenu,
        searchRef,
        onItemEnter: React19.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ),
        onItemLeave: React19.useCallback(
          (event) => {
            var _a;
        ...
        onPointerGraceIntentChange: React19.useCallback((intent) => {
...
var MenuGroup = React19.forwardRef(
  (props, forwardedRef) => {
...
var MenuLabel = React19.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemImpl = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textContent, setTextContent] = React19.useState("");
    React19.useEffect(() => {
      const menuItem = ref.current;
      if (menuItem) {
...
var MenuCheckboxItem = React19.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioGroup = React19.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemIndicator = React19.forwardRef(
  (props, forwardedRef) => {
...
var MenuArrow = React19.forwardRef(
  (props, forwardedRef) => {
...
var MenuSubTrigger = React19.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const rootContext = useMenuRootContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const subContext = useMenuSubContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const contentContext = useMenuContentContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const openTimerRef = React19.useRef(null);
    const { pointerGraceTimerRef, onPointerGraceIntentChange } = contentContext;
    const scope = { __scopeMenu: props.__scopeMenu };
    const clearOpenTimer = React19.useCallback(() => {
      if (openTimerRef.current) window.clearTimeout(openTimerRef.current);
      openTimerRef.current = null;
    }, []);
    React19.useEffect(() => clearOpenTimer, [clearOpenTimer]);
    React19.useEffect(() => {
...
var MenuSubContent = React19.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext(CONTENT_NAME2, props.__scopeMenu);
